...
date: 2025-01-01
description: An example blog post showing how the Pocket Agent blog engine works. Replace this with your own content.
...
Blog posts are markdown files in `src/pocket_agent/web/static/blog/posts/`. Each file needs frontmatter between `---` markers at the top:
